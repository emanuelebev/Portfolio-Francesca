...
const greeting = {
  ...
  subTitle: emoji(
    ...
    "I'm Francesca, an ethusiastic Software Engineer 🚀 dedicated to crafting innovative solutions through code. Welcome to my portfolio, where you'll find a curated collection of my projects, code samples, and a glimpse into my journey as a software engineer, feel free to explore!"
